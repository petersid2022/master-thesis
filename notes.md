...
- [Speculative Speculative Decoding](#speculative-speculative-decoding)
- [Resources](#resources)
- [Footnote](#footnote)
...
*from: [Reward-Guided Speculative Decoding for Efficient LLM Reasoning](#ref-reward-guided-speculative-decoding-for-efficient-llm-reasoning)*
...
## [Accelerating Large Language Model Decoding with Speculative Sampling](#ref-accelerating-large-language-model-decoding-with-speculative-sampling)
> [!TIP]
...
## [A Hitchhiker's Guide to Speculative Decoding](#ref-a-hitchhikers-guide-to-speculative-decoding)
> [!TIP]
...
## [Speculative Sampling Explained](#ref-speculative-sampling-explained)
> [!TIP]
> Use a draft sampling to achieve the same sampling result as the target sampling

## [Fast Inference from Transformers via Speculative Decoding](#ref-fast-inference-from-transformers-via-speculative-decoding)
> [!TIP]
...
## [Reward-Guided Speculative Decoding for Efficient LLM Reasoning](#ref-reward-guided-speculative-decoding-for-efficient-llm-reasoning)
> [!TIP]
...
## [Speculative Speculative Decoding](#ref-speculative-speculative-decoding)
> [!TIP]
...
## Resources
1. <span id="ref-speculative-sampling"></span> [Speculative Sampling](https://github.com/hemingkx/SpeculativeDecodingPapers)
2. <span id="ref-llama-cpp-docs-speculative-md"></span> [llama.cpp: docs/speculative.md](https://github.com/ggml-org/llama.cpp/blob/master/docs/speculative.md)
3. <span id="ref-must-read-papers-and-blogs-on-speculative-decoding"></span> [Must-read papers and blogs on Speculative Decoding](https://github.com/hemingkx/SpeculativeDecodingPapers)
4. <span id="ref-accelerating-large-language-model-decoding-with-speculative-sampling"></span> [Accelerating Large Language Model Decoding with Speculative Sampling](https://arxiv.org/abs/2302.01318)
5. <span id="ref-accelerating-llm-inference-with-staged-speculative-decoding"></span> [Accelerating LLM Inference with Staged Speculative Decoding](https://arxiv.org/abs/2308.04623)
6. <span id="ref-looking-back-at-speculative-decoding-hacker-news"></span> [Looking Back at Speculative Decoding HN](https://news.ycombinator.com/item?id=43216518)
7. <span id="ref-instantaneous-grammatical-error-correction-with-shallow-aggressive-decoding"></span> [Instantaneous Grammatical Error Correction with Shallow Aggressive Decoding](https://arxiv.org/abs/2106.04970)
8. <span id="ref-a-hitchhikers-guide-to-speculative-decoding"></span> [A Hitchhiker's Guide to Speculative Decoding](https://pytorch.org/blog/hitchhikers-guide-speculative-decoding)
9. <span id="ref-looking-back-at-speculative-decoding"></span> [Looking back at speculative decoding](https://research.google/blog/looking-back-at-speculative-decoding)
10. <span id="ref-learning-harmonized-representations-for-speculative-sampling"></span> [Learning Harmonized Representations for Speculative Sampling](https://arxiv.org/abs/2408.15766)
20. <span id="ref-llama-cpp-speculative-sampling-2x-faster-inference-for-large-models"></span> [Llama.cpp speculative sampling: 2x faster inference for large models](https://news.ycombinator.com/item?id=37390024)
12. <span id="ref-speculative-poc-for-speeding-up-inference-via-speculative-sampling-by-ggerganov"></span> [Speculative: PoC for speeding-up inference via speculative sampling by ggerganov](https://news.ycombinator.com/item?id=37357783)
13. <span id="ref-speculative-sampling-explained"></span> [Speculative Sampling Explained](https://saibo-creator.github.io/post/2024_03_08_speculative_sampling)
14. <span id="ref-llama-add-example-for-speculative-sampling-2030"></span> [llama : add example for speculative sampling #2030](https://github.com/ggml-org/llama.cpp/issues/2030)
15. <span id="ref-speculative-poc-for-speeding-up-inference-via-speculative-sampling-#2926"></span> [speculative : PoC for speeding-up inference via speculative sampling #2926](https://github.com/ggml-org/llama.cpp/pull/2926)
16. <span id="ref-enable-speculative-decoding-5800"></span> [Enable speculative decoding #5800](https://github.com/ollama/ollama/issues/5800)
17. <span id="ref-understanding-llm-system-with-3-layer-abstraction"></span> [Understanding LLM System with 3-layer Abstraction](https://ralphmao.github.io/ML-software-system)
18. <span id="ref-speculative-decoding-for-2x-faster-whisper-inference"></span> [Speculative Decoding for 2x Faster Whisper Inference](https://huggingface.co/blog/whisper-speculative-decoding)
19. <span id="ref-speculative-refactor-and-add-a-simpler-example-10362"></span> [speculative : refactor and add a simpler example #10362](https://github.com/ggml-org/llama.cpp/pull/10362)
20. <span id="ref-fast-inference-from-transformers-via-speculative-decoding"></span> [Fast Inference from Transformers via Speculative Decoding](https://arxiv.org/abs/2211.17192)
21. <span id="ref-speculative_decoding-ipynb"></span> [speculative_decoding.ipynb](https://colab.research.google.com/github/sanchit-gandhi/notebooks/blob/main/speculative_decoding.ipynb#scrollTo=af0b3757-72dc-48a8-9d9d-fc135386cae5)
22. <span id="ref-medusa:-simple-llm-inference-acceleration-framework-with-multiple-decoding-heads"></span> [Medusa: Simple LLM Inference Acceleration Framework with Multiple Decoding Heads](https://arxiv.org/abs/2401.10774)
23. <span id="ref-reward-guided-speculative-decoding-for-efficient-llm-reasoning"></span> [Reward-Guided Speculative Decoding for Efficient LLM Reasoning](https://arxiv.org/abs/2501.19324)
24. <span id="ref-speculative-speculative-decoding"></span> [Speculative Speculative Decoding](https://arxiv.org/pdf/2603.03251)
